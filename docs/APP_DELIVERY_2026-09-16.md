...
| 푸시 이벤트 4종 (started/ended/failed/skipped) | ✅ 발송 중 | 스테이징 검증 (§3) |
...
1. **푸시 스테이징 검증 4종** — started / ended / failed / skipped. 결과 공유 부탁드립니다. 실패 시 `push_outbox.last_error` 에 응답이 남으니 저희가 바로 볼 수 있습니다.
