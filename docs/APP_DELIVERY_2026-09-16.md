...
| 푸시 이벤트 발송 | ⏸️ **secret 수령 후 활성화** (started/ended/failed/skipped 4종 함께) |
...
9/16 결정 회신으로 **7건 전부 해소**됐습니다. 남은 건 secret 하나뿐입니다.

| # | 필요한 것 | 그러면 |
|:---:|---|---|
| 1 | **`PUSH_EVENT_INGEST_SECRET`** (별도 채널) | 환경변수 2줄 + 브리지 재시작으로 4종 발송 시작 |

~~skipped 발송 신호~~ — 2026-09-16 수신, 반영 완료.
