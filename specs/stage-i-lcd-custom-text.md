...
## 글자수 가이드 (128×24 밴드, 폰트 자동 축소)
서버가 밴드 폭에 맞춰 폰트 크기를 자동 조절(최대 21px ~ 최소 8px). 하드 상한 64자.

| | 최적(21px) | 권장 상한 | 그 이상 |
|---|---|---|---|
| 한글 | ~7자 | **8~9자** | 10자+ 축소(12~14px) |
| 영문/숫자 | ~8자 | **~12자** | 15자+ 축소, 20자면 10px |

- 규칙: **한글 8자 / 영문 12자 이내면 크고 선명.** 폭 기준 한글 1자 ≈ 영문 2자.
- 앱/웹 UI 에 이 권장선을 안내(웹 콘솔은 글자수 카운터 + 힌트 표시).
